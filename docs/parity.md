...
- `tui_malformed_mouse_ignored`: malformed SGR mouse reports such as VS Code's `ESC[<32;NaN;NaNM` focus-change noise are ignored instead of leaking characters into the prompt.
